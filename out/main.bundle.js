...
/***/ function(module, exports, __webpack_require__) {
	...
	var Application = function Application() {
	    ...
	    _utils2.default.loadTemplates(['HelloWorld', 'TopBar'], function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HelloWorldView = __webpack_require__(386);
	
	var _HelloWorldView2 = _interopRequireDefault(_HelloWorldView);
	
	var _TopBarView = __webpack_require__(395);
	...
	var Router = function (_Backbone$Router) {
	    ...
	    (0, _createClass3.default)(Router, [{
	        ...
	        value: function HelloWorld() {
	            new _HelloWorldView2.default();
	        }
	    }, {
	        key: 'TopBar',
	        value: function TopBar() {
	            new _TopBarView2.default();
	        }
	    }]);
	    return Router;
	}(Backbone.Router);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shared = __webpack_require__(309)('keys')
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
	__webpack_require__(317)(IteratorPrototype, __webpack_require__(356)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(315)(Function.call, __webpack_require__(374).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
	        buggy = !(test instanceof Array);
	      } catch(e){ buggy = true; }
	      return function setPrototypeOf(O, proto){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ObjectMenuView = function (_Backbone$View) {
	    ...
	    (0, _createClass3.default)(ObjectMenuView, [{
	        key: 'template',
	        get: function get() {
	            return _.template(_utils2.default.templates.HelloWorld);
	        }
	    }, {
	        key: '$el',
	        get: function get() {
	            return (0, _jquery2.default)('.HelloWorldSelector');
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Loader = function () {
	    ...
	    (0, _createClass3.default)(Loader, [{
	        key: 'loadTemplates',
	        value: function loadTemplates(names, callback) {
	            var that = this;
	            var loadTemplate = function loadTemplate(index) {
	                var name = names[index];
	                _jquery2.default.get('./templates/' + name + '.html', function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(390), __webpack_require__(388), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ObjectMenuView = function (_Backbone$View) {
	    ...
	    (0, _createClass3.default)(ObjectMenuView, [{
	        key: 'template',
	        get: function get() {
	            return _.template(_utils2.default.templates.TopBar);
	        }
	    }, {
	        key: '$el',
	        get: function get() {
	    ...
	    (0, _createClass3.default)(ObjectMenuView, [{
	        ...
	        key: 'getNewTabName',
	        value: function getNewTabName() {
	
	            for (var i = 1; i < this.tabArray.length + 1; i++) {
	                if (this.tabArray.indexOf("Scene - " + i) == -1) return "Scene - " + i;
	            }
	        ...
	        value: function renameTab(ev) {
	            ...
	            if (index > -1) this.tabArray[index] = newName;
